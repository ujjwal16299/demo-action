...
export type Query = {
  ...
  cardJson?: Maybe<CardJson>;
  allCardJson: CardJsonConnection;
};
...
export type QueryAllCardJsonArgs = {
  filter?: InputMaybe<CardJsonFilterInput>;
  sort?: InputMaybe<Array<InputMaybe<CardJsonSortInput>>>;
  skip?: InputMaybe<Scalars['Int']>;
  limit?: InputMaybe<Scalars['Int']>;
};
...
export type CardJsonConnection = {
  totalCount: Scalars['Int'];
  edges: Array<CardJsonEdge>;
  nodes: Array<CardJson>;
  pageInfo: PageInfo;
  distinct: Array<Scalars['String']>;
  max?: Maybe<Scalars['Float']>;
  min?: Maybe<Scalars['Float']>;
  sum?: Maybe<Scalars['Float']>;
  group: Array<CardJsonGroupConnection>;
};


export type CardJsonConnectionDistinctArgs = {
  field: CardJsonFieldSelector;
};


export type CardJsonConnectionMaxArgs = {
  field: CardJsonFieldSelector;
};


export type CardJsonConnectionMinArgs = {
  field: CardJsonFieldSelector;
};


export type CardJsonConnectionSumArgs = {
  field: CardJsonFieldSelector;
};


export type CardJsonConnectionGroupArgs = {
  skip?: InputMaybe<Scalars['Int']>;
  limit?: InputMaybe<Scalars['Int']>;
  field: CardJsonFieldSelector;
};

export type CardJsonEdge = {
  next?: Maybe<CardJson>;
  node: CardJson;
  previous?: Maybe<CardJson>;
};

export type CardJsonFieldSelector = {
  title?: InputMaybe<FieldSelectorEnum>;
  description?: InputMaybe<FieldSelectorEnum>;
...
export type CardJsonGroupConnection = {
  totalCount: Scalars['Int'];
  edges: Array<CardJsonEdge>;
  nodes: Array<CardJson>;
  pageInfo: PageInfo;
...
export type CardJsonGroupConnectionDistinctArgs = {
  field: CardJsonFieldSelector;
};


export type CardJsonGroupConnectionMaxArgs = {
  field: CardJsonFieldSelector;
};


export type CardJsonGroupConnectionMinArgs = {
  field: CardJsonFieldSelector;
};


export type CardJsonGroupConnectionSumArgs = {
  field: CardJsonFieldSelector;
};


export type CardJsonGroupConnectionGroupArgs = {
  skip?: InputMaybe<Scalars['Int']>;
  limit?: InputMaybe<Scalars['Int']>;
  field: CardJsonFieldSelector;
};

export type CardJsonFilterInput = {
  title?: InputMaybe<StringQueryOperatorInput>;
  description?: InputMaybe<StringQueryOperatorInput>;
  imageUrl?: InputMaybe<StringQueryOperatorInput>;
  buttonText?: InputMaybe<StringQueryOperatorInput>;
